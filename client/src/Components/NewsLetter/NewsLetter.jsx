...
const Newsletter = ()=>{
    return (
        <div class="text-white text-center font-montserrat mb-36">
            <div>
                <p class="text-3xl xl:text-5xl not-italic font-bold leading-normal inline relative">SUSCRÍBETE
                <span class="absolute w-1/2 h-1 bg-darkGreen bottom-[-0.5rem] left-1/4"></span>
                </p>
            </div>
            <div class="mt-10 xl:mt-14 max-w-[22rem] xl:max-w-[70rem] mx-auto text-center">
                 <p class="text-base xl:text-2xl">¡Únete a nuestra newsletter semanal en FitAI y descubre un mundo de bienestar! Recibe consejos, dietas personalizadas y mucho más para alcanzar tus metas fitness. ¡Únete a nuestra comunidad saludable hoy mismo y comienza a transformar tu vida!</p>
            </div>
            <div>
                <FormNewsletter />
            </div>
