    ...
    <div>
      <form class="mt-16 text-white" onSubmit={handleSubmit}>
        <div class="flex items-center justify-center">
          <input
            class=" w-52 h-11 text-black p-3 text-lg focus:outline-none font-montserrat font-normal not-italic leading-normal"
            type="email"
            name="email"
          ...
          <button
            class=" w-28 h-11 border-darkGreen bg-darkGreen p-1 text-center  text-[0.65rem] not-italic font-montserrat font-bold leading-normal transition duration-300 ease-in-out transform hover:scale-105 text-white hover:bg-gray-900 hover:border-gray-900"
            type="submit"
      ...
      ></div>
      <div> {errors.email ?
      <div class="bg-red-500 text-white font-bold rounded-3xl border border-red-500 p-2 shadow-md w-[18.5rem] ml-4 mt-4">
      ...
      <div class=" bg-green-700 text-white font-bold rounded-3xl border border-green-700 p-2 shadow-md w-[18.5rem] ml-4 mt-4">
      <div class="flex items-center">
        <svg class="w-6 h-6 text-black mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01"></path>
          <circle cx="12" cy="12" r="10" stroke="currentColor" stroke-width="2"></circle>
