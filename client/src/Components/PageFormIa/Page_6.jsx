    ...
    const handleChange = (e) =>{
        ...
        if(name === "diasEntrenamiento"){
            if(value >= 3 && value <= 7){
                ...
                setError("Por favor, elige entre 3 y 6 días para tu rutina semanal de entrenamiento.")
            }
        }
            ...
            <div class="xl:flex xl:translate-x-7 2xl:translate-x-0">
                <div class="xl:w-[25rem] 2xl:w-[43rem]">
                    ...
                    <div class="flex items-end justify-center mt-4 xl:mt-6 2xl:mt-12">
                        ...
                        <label class="mt-2 flex text-center text-red-500 font-montserrat font-bold leading-normal not-italic">{error}</label>
                </div>
