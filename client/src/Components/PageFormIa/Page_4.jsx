    ...
    return(
        <div class="flex flex-col relative h-full p-5">
            <div class="flex flex-col"> 
                <p class="font-montserrat text-xl xl:text-4xl 2xl:text-6xl not-italic font-bold leading-normal text-center 2xl:mb-8 text-lightBlue">¿Cuál es tu objetivo principal?</p>
            ...
            <div>
            <p class="font-montserrat text-xl xl:text-4xl 2xl:text-6xl not-italic font-bold leading-normal text-center text-lightBlue">¿Cuál es tu nivel de experiencia entrenando?</p>
